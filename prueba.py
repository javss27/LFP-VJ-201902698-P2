...
ids= "_274urhd739 _e a _ _d2_2_2 32_ 89 id ide4 ___id2 s78565 _"
#para decimales
print(re.findall(r'\-?\d*\.\d+\s',cadena))

#para ids
print("\n",re.findall(r'[a-z*|_][_\w]+|[a-z]',ids))

#para cadenas(strings)
cadenas = "\"cadena1\" \"\" \"shs^&*>}23\"  \"cadena ca"
print("\n",re.findall(r'\".*\"',cadenas))

#comentarios multilinea

comentario = "/*alg234#$%^% o \n otro \n fin*/  algo /*"
#print(comentario)
print("\n",re.findall(r'(\/\*(\s*|.*?)*\*\/)',comentario))
